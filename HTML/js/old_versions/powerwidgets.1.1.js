...
;(function($, window, document, undefined){
    $.fn.powerWidgets = function(options) { 
	
		options = $.extend({}, $.fn.powerWidgets.options, options); 
			...
			return this.each(function() {  
				...
				**/
				...
				//*****************************************************************//						
					...
					**/
					if(localStorage && o_localStorage && getKeyPosition){
					...
					widget.each(function(){
						...
						**/
						if(o_allowCustom === true && $(this).data('widget-custombutton') === undefined){	
							var customBtn = '<a href="#" class="button-icon powerwidget-custom-btn"><span class="'+o_customClass[0]+'"></span></a>';
						}else{
							    customBtn = '';
						}
						...
						**/
						if(o_allowDelete === true && $(this).data('widget-deletebutton') === undefined){	
							var deleteBtn = '<a href="#" class="button-icon powerwidget-delete-btn"><span class="'+o_deleteClass+'"></span></a>';
						}else{
							    deleteBtn = '';
						}
						...
						**/
						if(o_allowEdit === true && $(this).data('widget-editbutton') === undefined){	
							var editBtn = '<a href="#" class="button-icon powerwidget-edit-btn"><span class="'+o_editClass[0]+'"></span></a>';
						}else{
							    editBtn = '';
						}
						...
						**/
						if(o_allowFullscreen === true && $(this).data('widget-fullscreenbutton') === undefined){	
							var fullscreenBtn = '<a href="#" class="button-icon powerwidget-fullscreen-btn"><span class="'+o_fullscreenClass[0]+'"></span></a>';
						}else{
							    fullscreenBtn = ''; 
						}
						...
						**/
						if(o_allowToggle === true && $(this).data('widget-togglebutton') === undefined){	
							...
							var toggleBtn = '<a href="#" class="button-icon powerwidget-toggle-btn"><span class="'+toggleSettings+'"></span></a>';
						}else{
							    toggleBtn = '';							
						}
						...
						**/
                        if(o_refreshButton === true && $(this).data('widget-refreshbutton') != false && $(this).data('widget-load')){
							var refreshBtn = '<a href="#" class="button-icon powerwidget-refresh-btn"><span class="'+o_refreshButtonClass+'"></span></a>';	
						}else{
							    refreshBtn = '';
						}
				...
				//*****************************************************************//
					...
					function heightFullscreen(){
						if($('#powerwidget-fullscreen-mode').length){
							...
							**/
							...
							var heightHeader  = $('#powerwidget-fullscreen-mode').find(o_widgetClass).children('header').height();
					...
					**/
					widget.on(clickEvent,'.powerwidget-fullscreen-btn', function(e){
				...
				//*****************************************************************//
					...
					**/
					widget.on(clickEvent,'.powerwidget-edit-btn', function(e){
				...
				//*****************************************************************//
					...
					* Allow users to show/hide a edit box.
					**/
					widget.on(clickEvent,'.powerwidget-custom-btn', function(e){
				...
				//*****************************************************************//
					...
					**/
					widget.on(clickEvent,'.powerwidget-delete-btn', function(e){
				...
				//******************************************************************//
					...
					**/
					if(o_allowSortable === true){
						...
						sortItem.sortable({
							items:                sortItem.find('.powerwidget-sortable').not(''),
					...
					if(o_allowAjax === true){
						...
						**/
						obj.find('[data-widget-load]').each(function(){
							...
							**/
							thisItem.children('div:first').append('<div class="powerwidget-ajax-placeholder"><span style="margin:10px">'+o_loadingLabel+'</span></div>');
						...
						**/
						widget.on(clickEvent, '.powerwidget-refresh-btn', function(e){
