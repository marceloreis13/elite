...
asyncTest("Different document context", function() {
  ...
  new wysihtml5.dom.Sandbox(function(sandbox) {
    ...
    result = wysihtml5.dom.getAsDom("<header>hello    <!-- // HTML5/CSS3 support // -->

    <script src="js/modernizr.min.js"></script>
                
</header>", sandbox.getDocument());
    equal(result.innerHTML.toLowerCase(), "<header>hello    <!-- // HTML5/CSS3 support // -->
